...
/* "kitty", "-1", "--instance-group", "kitty_sock", "-o",
 * "allow_remote_control=yes", "--listen-on", "unix:/tmp/kitty_sock", */
/* const char *spcmd1[] = {"st", "-n", "term", "-g", "70x13", NULL}; */
const char *spcmd1[] = {"kitty",
                        "-1",
                        "--instance-group",
                        "kitty_sock",
                        "-o",
                        ...
                        "-o",
                        "initial_window_height=11c",
                        NULL};
const char *spcmd2[] = {"zotero", NULL};
const char *spcmd3[] = {"st",    "-n", "vifm",    "-g",
                        "80x14", "-e", "vifmrun", NULL};
const char *spcmd4[] = {"kitty",
                        "-1",
                        "--instance-group",
                        "kitty_sock",
                        "-o",
...
static Sp scratchpads[] = {
    /* name          cmd  */
    {"term", spcmd1},    {"zotero", spcmd2}, {"vifm", spcmd3},
    {"btop", spcmd4},    {"Pidgin", spcmd5}, {"nchat", spcmd6},
    {"ncmpcpp", spcmd7}, {"thunar", spcmd8},
...
static const Rule rules[] = {
    ...
    RULE(.wintype = WTYPE "DIALOG",
        ...
        RULE(.wintype = WTYPE "TOOLBAR",
            ...
            RULE(.wintype = WTYPE "Popup",
                 .isfloating = 1) RULE(.class = "Gimp", .tags = 1 << 4)
                RULE(.class = "Zotero", .instance = "Zotero", .isfloating = 1)
                    RULE(.title = "Progress") RULE(.class = "firefox",
                                                   .tags = 1 << 0)
                        RULE(.class = "firefox", .title = "Zotero Connector",
                             .isfloating = 1) RULE(.instance = "Browser",
                                                   .isfloating = 1)
                            RULE(.instance = "Places", .isfloating = 1,
                                 .iscentered = 1)
                                RULE(.instance = "dosbox-x", .isfloating = 1)
                                    RULE(.instance = "Syncthing GTK",
                                         .isfloating = 1)
    /* RULE(.title = "Zotero", .tags = 1 << 1, .monitor =1, .switchtag =1,
       .iscentered = 1) */
    RULE(.class = "Zotero", .instance = "Navigator", .tags = 1 << 2,
         .monitor = 1,
         .switchtag =
             1) RULE(.instance = "r_x11", .isfloating = 1,
                     .floatpos = "100% 0% 40% 40%") RULE(.class = "gimp",
                                                         .tags = 1 << 4)
        RULE(.instance = "Alacritty", .tags = 1 << 4, .monitor = 'A',
             .switchtag = 3) RULE(.instance = "st-256color", .tags = 1 << 4,
                                  .monitor = 'A',
                                  .switchtag = 3) RULE(.instance = "kitty",
                                                       .tags =
                                                           1 << 4,
                                                       .monitor = 'A',
                                                       .switchtag = 3)
            RULE(.class = "okular", .tags = 1 << 1, .monitor = 1,
                 .switchtag = 1) RULE(.class = "sioyek", .tags = 1 << 1,
                                      .monitor = 1, .switchtag = 1)
                RULE(.class = "qutebrowser", .tags = 1, .monitor = 1,
                     .switchtag = 1) RULE(.class = "calibre", .tags = 1 << 8,
                                          .monitor = 1, .switchtag = 3,
                                          .iscentered = 1) RULE(.class =
                                                                    "Evince",
                                                                .tags = 1 << 1,
                                                                .monitor = 1,
                                                                .switchtag = 3)
                    RULE(.title = "LibreOffice", .tags = 1 << 1, .monitor = 0,
                         .switchtag = 'A',
                         .iscentered = 1) RULE(.title = "Document Recovery",
                                               .iscentered = 1, .isfloating = 1)
                        RULE(.instance = "winword.exe", .tags = 1 << 1,
                             .monitor = 0, .switchtag = 'A', .iscentered = 1)
                            RULE(.instance = "rstudio", .tags = 1 << 2,
                                 .monitor = 0, .switchtag = 1, .iscentered = 1,
                                 .isfloating = 1) RULE(.instance = "rstudio",
                                                       .title = "Plot Zoom",
                                                       .isfloating = 1)
                                RULE(.instance = "code", .tags = 1 << 2,
                                     .monitor = 0,
                                     .switchtag = 1) RULE(.instance = "zoom",
                                                          .tags = 1 << 5,
                                                          .monitor = 1,
                                                          .switchtag = 1,
                                                          .isfloating = 1)
                                    RULE(.title = "Spotify", .tags = 1 << 8,
                                         .monitor = 1) RULE(.class = "firefox",
                                                            .title =
                                                                "^Extension: "
                                                                "(Zotero "
                                                                "Connector)",
                                                            .isfloating = 1,
                                                            .iscentered = 1)
                                        RULE(.instance = "Toplevel", .isfloating = 1) RULE(
                                                .class =
                                                    "GoldenDict",
                                                .isfloating = 1) RULE(.class = "QtScrcpy",
                                                                      .isfloating = 1)
                                            RULE(.class = "scrcpy", .isfloating = 1) RULE(
                                                    .class =
                                                        "mpv",
                                                    .isfloating = 1,
                                                    .floatpos =
                                                        "100% 0% 25% 25%") RULE(.instance = "Toolkit",
                                                                                .isfloating =
                                                                                    1,
                                                                                .floatpos = "100% 0% 25% 25%")
                                                RULE(.instance = "bitwarden",
                                                     .isfloating = 1,
                                                     .floatpos =
                                                         "100% 0%") RULE(.instance = "dosbox-x", .isfloating = 1)
                                                    RULE(.instance = "stardict", .isfloating = 1) RULE(
                                                            .instance =
                                                                "qnotero",
                                                            .isfloating = 1,
                                                            .floatpos =
                                                        ...
                                                        RULE(.instance =
                                                            ...
                                                            RULE(.instance =
                                                                 ...
                                                                 .iscentered =
                                                                     1)
                                                                RULE(.class = "Arandr", .isfloating = 1) RULE(
                                                                        .class =
                                                                            "Lx"
                                                                            "ap"
                                                                            "pe"
                                                                                            ...
                                                                                            RULE(.instance =
                                                                                                ...
                                                                                                RULE(.instance =
                                                                                                    ...
                                                                                                    RULE(.instance =
                                                                                                         ...
                                                                                                         .tags = SPTAG(
                                                                                                             0),
                                                                                                         .isfloating = 1, .floatpos = "50% 0%")
                                                                                                        RULE(.instance = "vifm", .tags = SPTAG(2), .isfloating = 1, .floatpos = "100% 0%")
                                                                                                            RULE(.instance = "btop", .tags = SPTAG(3), .isfloating = 1, .floatpos = "0% 100%") RULE(
                                                                                                                    .instance =
                                                                                                                        "Pidgin",
                                                                                                                    .tags =
                                                                                                                        SPTAG(4),
                                                                                                                    .isfloating = 1, .iscentered = 1)
                                                                                                                RULE(.instance = "nchat", .tags = SPTAG(5),
                                                                                                                     .isfloating = 1, .floatpos = "0% 100%")
                                                                                                                    RULE(.instance =
                                                                                                                             "ncmpcpp",
                                                                                                                         .tags = SPTAG(
                                                                                                                             6),
...
/* static const char *termcmd[]  = { "kitty -1 --instance-group kitty_sock-o
 * allow_remote=yes listen-on unix:/tmp/kitty_sock", NULL }; */
