...
const char *spcmd6[] = {"kitty", "--name", "rainbowstream", "-o", "initial_window_width=35c", "-o", "initial_window_height=40c", "-e", "rainbowstream",NULL};
...
static Key keys[] = {
	...
	{ MODKEY|ControlMask,           XK_j,          pushdown,         dwmc      {0} },
	...
	{ MODKEY|ControlMask,           XK_~,          showhideclient,         {0} },
	...
	{ MODKEY|ControlMask|ShiftMask, XK_y,          togglefakefullscreen,   {0} },
	#endif // FAKEFULLSCREEN_CLIENT_PATCH
	#if FULLSCREEN_PATCH
...
static IPCCommand ipccommands[] = {
	...
	#endif // TRANSFER_PATCHsuper + shift + {q,r}
	dwmc quit {0,1}
	#if TRANSFER_ALL_PATCH
	...
	IPCCOMMAND( togglegaps, 1, {ARG_TYPE_super + shift + {q,r}
	dwmc quit {0,1}NONE} ),
